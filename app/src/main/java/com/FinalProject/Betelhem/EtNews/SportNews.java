...
public class SportNews extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_sport_news, container, false);
        ...
        recyclerView = rootView.findViewById(R.id.local_Recycler);
...
return rootView;
    ...
    private void loadurl() {
        ...
        Call<RssObject> call = newsApi.fetchSportNews();
